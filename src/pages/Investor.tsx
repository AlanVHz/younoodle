        ...
        <form onSubmit={handleFormSubmit} className='w-full max-w-sm mt-20'>
          <div className='md:flex md:items-center mb-6'>
            ...
            <div className='md:w-2/3'>
              <input
                className='appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:teal-500'
                id='inline-full-name'
                type='text'
                value={investorsName}
              ...
              <div className='flex items-center justify-center md:w-3/3'>
                ...
                <div>
                  <select
                    ...
                    className='py-2 px-4 border-2 border-gray-200 rounded w-full text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-teal-500'
                  >
